...
from os import path
WAV_FILE = path.join(path.dirname(path.realpath(__file__)), "voice.wav")
...
# # IBM Speech to Text usernames are strings of the form
...
# # AT&T Speech to Text app secrets are 32-character lowercase alphanumeric
# # strings
# ATT_APP_SECRET = "INSERT AT&T SPEECH TO TEXT APP SECRET HERE"
# try:
#     print("AT&T Speech to Text thinks you said " +
#           r.recognize_att(audio, app_key=ATT_APP_KEY, app_secret=ATT_APP_SECRET))
# except sr.UnknownValueError:
